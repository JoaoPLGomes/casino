...
export const Menu = () => (
  <div className="menu__container">
    <NavLink className="menu__link" activeClassName="menu-link_active" to="/Exercise1">Exercise 1</NavLink>
    <NavLink className="menu__link" activeClassName="menu-link_active" to="/Exercise2">Exercise 2</NavLink>
    <NavLink className="menu__link" activeClassName="menu-link_active" to="/Exercise3">Exercise 3</NavLink>
