  ...
  getRandomValue = () => {
    if(this.state.coins > 0) {
      this.setState({
        ...
        results: [this.reel1[Math.floor(Math.random() * this.reel1.length)], this.reel2[Math.floor(Math.random() * this.reel2.length)], this.reel3[Math.floor(Math.random() * this.reel3.length)]]},
      () => {
      ...
      <>
        <div className="exercise4__container">
          ...
          <div className="exercise4-reel__container">
            ...
            <button className="exercise4__button" onClick={this.getRandomValue}>Click to Play</button>
